...
import einops
from models.triplane.utils import trunc_normal_
...
class ShiftWindowAttention(LocalAttention):
    ...
    def __init__(self, dim, heads, window_size, attn_drop, proj_drop, shift_size, fmap_size):
        ...
        self.fmap_size = fmap_size  # to_2tuple(fmap_size)
...
class DAttentionBaseline(nn.Module):
    ...
    def forward(self, x):
        ...
        y = self.proj_drop(self.proj_out(out.contiguous()))
