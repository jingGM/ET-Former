...
from models.voxformer.encoder import VoxFormerEncoder
...
class PerceptionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = VoxFormerEncoder(transformerlayers=encoder.transformerlayers, image_size=encoder.image_size,
                                        num_layers=encoder.num_layers,
                                        num_points_in_pillar=encoder.num_points_in_pillar,
                                        return_intermediate=encoder.return_intermediate)
    ...
    def get_vox_features(
        ...
        unmasked_ref_3d = unmasked_ref_3d.unsqueeze(0).unsqueeze(0)
    ...
    def diffuse_vox_features(
        ...
        if unmasked_idx is not None:
            ...
            unmasked_ref_3d = torch.from_numpy(ref_3d).unsqueeze(0).unsqueeze(0)
